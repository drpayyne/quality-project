...
// Criterion Nine schema
var criterionNineSchema = mongoose.Schema({
...
let CriterionNine = module.exports = mongoose.model('CriterionNine',criterionNineSchema,'criterion_Nine');
